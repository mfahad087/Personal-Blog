...
if($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if(isset($_FILES['featured_image']) && $_FILES['featured_image']['error'] == 0) {
        ...
        if(!in_array($file_type, $allowed_types)) {
            ...
            if($featured_image && file_exists("../images/uploads/" . $featured_image)) {
                unlink("../images/uploads/" . $featured_image);
            }
...
<head>
    ...
    <title>Edit Post - The Fahad's Space</title>
        ...
        <main class="admin-main">
            <div class="main-header">
                <div>
                    ...
                    <p class="text-muted">Edit existing blog post</p>
                </div>
                <div>
            ...
            <form method="POST" enctype="multipart/form-data">
                <input type="hidden" name="existing_image" value="<?php echo $post['featured_image']; ?>">
                
                <div class="post-preview-container">
                    <div class="image-preview-box">
                        <div class="preview-placeholder has-image" id="imagePreview">
                            <?php if($post['featured_image']): ?>
                                <img src="../images/uploads/<?php echo $post['featured_image']; ?>" alt="Current Image">
                            <?php else: ?>
                        ...
                        <div class="current-image">
                            <?php if($post['featured_image']): ?>
                                <i class="fas fa-info-circle"></i> Current image: <?php echo $post['featured_image']; ?>
                            <?php else: ?>
                    ...
                    <div class="post-details-box">
                        ...
                        <div class="form-group">
                            ...
                            <small class="text-muted">Leave empty to keep current image. JPG, PNG, GIF (Max 5MB)</small>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="status-toggle">
                                <div class="status-option <?php echo $post['status'] == 'draft' ? 'active' : ''; ?>" data-status="draft">
                                    <i class="fas fa-edit"></i> Draft
                                </div>
                                <div class="status-option <?php echo $post['status'] == 'published' ? 'active' : ''; ?>" data-status="published">
